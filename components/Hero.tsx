  ...
  return (
    ...
    >
      <div className="flex flex-col items-center  pt-28 ">
        ...
        >
          Improve your hiring process with an easy AI solution
        </motion.p>
        ...
        >
          Hirespark empowers businesses, institutions, and recruiters to
          streamline and elevate their screening and recruitment processes.
        </motion.p>
